...
# write.csv(tables7,"data/gnomad_abl/table_s7.csv")
```
```{r}
...
data <- imatdata_gnomad%>%filter(dose%in%"1200nM") %>% 
...
ggsave("output/gnomad_figures/clin_char_piechart.pdf",width=3.5,height = 2.5, units="in",useDingbats=F)
