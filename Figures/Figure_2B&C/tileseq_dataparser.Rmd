...
Plotting figures 2B and 2C for the manuscript
...
ggsave(paste(dirname,"Fig_2b_",dose,"_",seqtech,"_",date,".pdf",sep=""),width=4,height=4,units="in",useDingbats=F)
...
ggplot(standards%>%filter(!protein_start%in%c("354:361")),aes(x=.055-drug_effect,y=netgr_obs_mean_corr,label=species))+
  ...
  theme(legend.position = c(0.92,0.45),
        ...
        axis.text.y=element_text(color="black",size=8),
        plot.margin=grid::unit(c(1,1,1,1), "mm"))
 ggsave(paste(dirname,"Fig_2c_",dose,"_",seqtech,"_",date,".pdf",sep=""),width=2.5,height = 2.5,units="in",useDingbats=F)
```
