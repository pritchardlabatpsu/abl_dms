---
title: "4.Fig1GHI_mutant_standards"
author: "Haider Inam"
date: "`r Sys.Date()`"
...
```{r}
a=data%>%filter(is_intended%in%1,seqtech%in%"tileseq")
median(a$ct_screen1_before)
```
...
standards=read.csv("Figures/Figure_1/inputs/ic50data_all_conc.csv",header = T,stringsAsFactors = F)
...
ggsave("Figures/Figure_1/Fig1H_duplex.pdf",width=2.5,height=2.5,units = "in",useDingbats=F)
...
geom_point(size=2,shape=21,fill="#8ED3C7",aes(x=.055-standards_tileseq$drug_effect,y=standards_tileseq$netgr_obs_screen1))+
  ...
  theme(legend.position = c(0.92,0.45),
        ...
        axis.text.y=element_text(color="black",size=8),
        plot.margin=grid::unit(c(1,1,1,1), "mm"))
ggsave("Figures/Figure_1/Fig1I_tileseq.pdf",width=2.5,height=2.5,units = "in",useDingbats=F)
...
scale_x_continuous("Predicted Net Growth Rate (Hrs-1) \nClonal IC50",limits=c(-0.016,.06))+
  ...
  theme(legend.position = c(0.92,0.45),
        ...
        axis.text.y=element_text(color="black",size=8),
        plot.margin=grid::unit(c(1,1,1,1), "mm"))
ggsave("Figures/Figure_1/Fig1G_ngs.pdf",width=2.5,height=2.5,units = "in",useDingbats=F)
```
